		...
		<div class="container col-md-7">
			<div id="signupbox" style="margin-top:50px" class="col-sm-10 col-sm-offset-2">
				...
				<div class="col-md-12 col-md-offset-1">
					<label for="apellidos" class="col-md-12 control-label" ALIGN="justify">Por correo electronico se te notificara si tu proyecto fue aceptado</label>
				</div>
				<div class="col-md-12 col-md-offset-1">
          	<label for="apellidos" class="col-md-9 control-label" ALIGN="center">Gracias!</label>
				</div>
				<br><br><br>
