								...
								<div class="panel-body" >
									...
									<form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="col-md-12">
												<input type="password" class="form-control" name="Ipass" placeholder="Contraseña" value="" required >
											</div>
										</div>

										<div class="form-group">
											<label for="apellidos" class="col-md-6 control-label">Confirma contraseña:</label>
											<div class="col-md-12">
												<input type="password" class="form-control" name="Ipass2" placeholder="Contraseña" value="" required >
											</div>
										</div>
